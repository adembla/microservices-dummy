...
@JsonProperty("totalCost")
public void setTotalCost(double totalTax) {
this.totalCost = totalCost;
}

@Override
public String toString() {
	return "OrderDetail [customerId=" + customerId + ", dateofPurChase=" + dateofPurChase + ", modePayId=" + modePayId
			+ ", transactionId=" + transactionId + ", items=" + items + ", totalCost=" + totalCost
